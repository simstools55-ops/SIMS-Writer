...
def test_shared_snapshot_required_assets():
    required = [
        ...
        "knowledge/faq-evolution.md",
        "knowledge/conditional-editorial-opinion.md",
...
def test_shared_snapshot_manifest_hashes():
    ...
    assert manifest["integrated_version"] == "1.1.0"
